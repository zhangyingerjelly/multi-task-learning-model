...
<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{a}{b}*\int_{a}^{b}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{a}{b}*\int_{a}^{b}" title="\frac{a}{b}*\int_{a}^{b}" /></a>
